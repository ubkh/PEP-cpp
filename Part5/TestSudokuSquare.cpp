...
int main() {
    ...
    
    {
        ...
        cout << "Making a SudokuSquareSet with the numbers {3, 6, 7} in it, size should be 3: ";
        SudokuSquareSet s2;
        s2.insert(3);
        s2.insert(6);
        s2.insert(7);
        ...
        if (s2.size() == 3) {
            ...
            cout << "failed -- size() returned " << s2.size() << "\n";
            retval = 1;
        } 
    
        {
            cout << "Making a SudokuSquareSet with the numbers {3, 6, 7} in it, looping over it should get {3, 6, 7}: ";
        ...
        
        {
            ...
            cout << "Making a SudokuSquareSet with the numbers 1 to 9 in it, erasing 1, 4 and 7, and looping over it should get {2,3,5,6,8,9}: ";
